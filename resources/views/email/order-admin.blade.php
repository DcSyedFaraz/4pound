                        ...
                        <tbody>
                            <tr>
                                <td colspan="4" valign="top"
                                    style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px;background-color:#fff;border-bottom:4px solid #36b780;text-align:center">
                                            ...
                                            <tr>
                                                <td style="border-collapse:collapse;border:0;margin:0;padding:0;color:#555559;font-family:Arial,sans-serif;font-size:16px;line-height:26px">
                                                    <div>
                                                        ...
                                                        <br>
                                                        <strong>  Paper Topic : {{$data['paper_type']}}</strong>
                                                        <br>
                                                        ...
                                                        <br>
                                                        <strong>  Price Per Page : {{ $data['cost_per_page'] }}</strong>
                                                        <br>
                                                        ...
                                                        <strong> Spacing : @if($data['spacing']==0)
                                                                ...
                                                                @endif</strong>
                                                        <br>
                                                        <strong>  Subject : {{ $data['subject_area'] }}</strong>
                                                        <br>
                                                        <br>
                                                    </div>
                                                </td>
                            ...
                            <tr bgcolor="#fff" style="border-top:4px solid #36b780">
